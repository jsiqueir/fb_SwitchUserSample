...
- (void)_updateContent:(NSNotification *)notification
{
    ...
    if ([FBSDKAccessToken currentAccessToken]) {
        ...
        self.subtitleLabel1.text = [FBSDKAccessToken currentAccessToken].expirationDate.description;
        self.subtitleLabel2.text = [FBSDKAccessToken currentAccessToken].refreshDate.description;
